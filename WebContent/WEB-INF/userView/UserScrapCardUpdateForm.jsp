...
<head>
   ...
   <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=6adcbe0b3032f5b5debc10494bf91325"></script>
	    ...
	    */
		...
		function searchPlaces(page)
	    {
	        ...
	        $.ajax(
	        {
	           ...
	           , headers : {"Authorization" : "KakaoAK 6adcbe0b3032f5b5debc10494bf91325"}
